...
import { Shield, Zap, Users, Globe, ArrowLeft, CheckCircle, Github } from "lucide-react";
    ...
    return (
        <main className="pt-24 pb-16 min-h-screen bg-background">
            <div className="container">
                ...
                <section className="bg-gradient-to-br from-purple-500/10 to-blue-500/10 rounded-3xl p-8 md:p-12 border border-purple-500/20 mb-16">
                    <div className="flex flex-col md:flex-row items-center gap-8">
                        <div className="flex-1">
                            ...
                            <p className="text-lg text-muted-foreground mb-6">
                                PDFHubs is proudly open source. Our code is transparent, auditable, and available
                                for anyone to inspect, contribute to, or learn from. We believe in the power of
                                community-driven development and privacy through transparency.
                            </p>
                            <div className="flex flex-wrap gap-4">
                                <Button asChild size="lg" className="bg-purple-600 hover:bg-purple-700">
                                    <a
                                        href="https://github.com/Ridham-Savaliya/pdfhubs"
                                        target="_blank"
                                ...
                                <Button asChild variant="outline" size="lg">
                                    <a
                                        href="https://github.com/Ridham-Savaliya/pdfhubs/stargazers"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex items-center gap-2"
                                    >
                        ...
                        <div className="bg-card rounded-2xl border border-border p-6 space-y-4">
                            ...
                            <ul className="space-y-3">
                                {[
                                    "🔍 Complete transparency in how we process your files",
                                    "🛡️ Security through public code review",
                                    "🤝 Community contributions welcome",
                                    "📖 Learn from real-world PDF processing",
